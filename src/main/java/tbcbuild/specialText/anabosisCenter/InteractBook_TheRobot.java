...
public class InteractBook_TheRobot extends SpecialText implements Printer {
    @Override
    public String description() {
        return "页码 0\n" +
                "如果玩家持有有电且未被锁定的 " + new Item_PersonalPanel_WangHao().getReferName() +
                "\n则 " + obtainSt(true, new InteractBook_UsableRobot()) +
                "\n\n\n" +
                "页码 1\n" +
                "\n" +
                "你好，欢迎来到新世界，我是亦亚\n" +
                ...
                "页码 5\n" +
                "\n" +
                "亦亚尚未连接到基地数据库，也尚未连接到你的个人终端。可能是网络波动导致，正在重试请稍等。\n" +
                "\n" +
                "A：有纸质地图吗？ （转到页码8）\n" +
                "B：火种复苏中心外是什么？ （转到页码9）\n" +
                "\n" +
                ...
                "页码 9\n" +
                "\n" +
                "火种复苏中心从大门外是复苏者康复中心，配备生活区，运动区，餐厅，娱乐区等设施。\n" +
    ...
    public CardPrinter printer() {
        return new PagesPureDescription() {{
            add("""
                    ...
                    If player hold unlocked Wanghaopanel which still open, then 
                    """.replace("Wanghaopanel", new Item_PersonalPanel_WangHao().getReferName()) + obtainSt(true, new InteractBook_UsableRobot()));
            add("""
                    Page 1
            ...
            add("""
                    ...
                    IA is not connected to the basement database, nor your personal panel. This might be the result of network turbulance.
                    Retrying... please wait.
                    
                    A: Do you have paper map? (Page 8)
                    B: What's beyond the anabosis center (Page 9)
                    """);
            add("""
                    Page 6
                    
                    Please seek the technical department's assistance.
            ...
            add("""
                    ...
                    I don't understand. Please check your personal panel, the map is on the clock
                    Hello, is there anything else I could help you today?
                """);
            add("""
                    Page 9
            ...
            @Override
            public String description() {
                return InteractBook_TheRobot.this.description();
            }
        };
    }
}
