...
public class Object_SmallElevatorInTechnicalDepartment2 extends ObjectCard implements Printer {
    public Object_SmallElevatorInTechnicalDepartment2(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_SmallElevatorInTechnicalDepartment2() {
        super();
    }
    ...
    public InteractiveList interactiveList() {
        return new InteractiveList() {{
            ...
            add(ic("耗费两点体力，强行打开电梯门"), new Finding_ElevatorMightNotOpen());
        }};
    }
        ...
        return new NormalCard() {
            ...
            public tbcbuild.cardGenerator.InteractiveList fpIl() {
                return new tbcbuild.cardGenerator.InteractiveList() {{
                    ...
                    add(InteractiveChoice.ic("Spend 2 physical power to open the elevator door"), new Finding_ElevatorMightNotOpen());
                }};
            }
