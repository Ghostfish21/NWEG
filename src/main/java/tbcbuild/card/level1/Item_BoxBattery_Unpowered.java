...
public class Item_BoxBattery_Unpowered extends ItemCard implements Duplicate, Printer {
    @Override
    public String description() {
        return "这似乎是一块没电了的电池。一大块黑色的东西，像砖头一样。你毫不怀疑只要用力就可以拿这块砖头对别人造成可观的伤害。\n" +
                "\n" +
                "正面是电池的渲染图\n" +
                "背面是电池上的信息\n" +
                "Rodríguez兄弟工业集团\n" +
    ...
    public Item_BoxBattery_Unpowered(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Item_BoxBattery_Unpowered() {
        super();
    }
