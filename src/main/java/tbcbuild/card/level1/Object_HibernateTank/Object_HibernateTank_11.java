...
public class Object_HibernateTank_11 extends ObjectCard implements Printer {
    public Object_HibernateTank_11(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_11() {
        super();
    }
