...
public class Object_HibernateTank_01 extends ObjectCard implements Printer {
    public Object_HibernateTank_01(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_01() {
        super();
    }
