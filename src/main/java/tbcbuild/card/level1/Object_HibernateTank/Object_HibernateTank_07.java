...
public class Object_HibernateTank_07 extends ObjectCard implements Printer {
    public Object_HibernateTank_07(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_07() {
        super();
    }
