...
public class Object_HibernateTank_14 extends ObjectCard implements Printer {

    public Object_HibernateTank_14(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_14() {
        super();
    }
