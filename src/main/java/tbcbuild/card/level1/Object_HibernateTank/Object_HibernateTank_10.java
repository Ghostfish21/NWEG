...
public class Object_HibernateTank_10 extends ObjectCard implements Printer {

    public Object_HibernateTank_10(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_10() {
        super();
    }
