...
public class Object_HibernateTank_03 extends ObjectCard implements Printer {
    public Object_HibernateTank_03(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_03() {
        super();
    }
