...
public class Object_HibernateTank_06 extends ObjectCard implements Printer {
    public Object_HibernateTank_06(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_06() {
        super();
    }
