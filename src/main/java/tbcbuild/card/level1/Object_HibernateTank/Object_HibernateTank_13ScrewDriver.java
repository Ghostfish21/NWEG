...
import tbcbuild.card.level1.Item_ScrewDriver;

import static tbcbuild.Util.obtain;

public class Object_HibernateTank_13ScrewDriver extends ObjectCard implements Printer {
    public Object_HibernateTank_13ScrewDriver(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_13ScrewDriver() {
        super();
    }
    ...
    public String description() {
        return "这是一个破败的冬眠仓，它本该光洁的外表上现在布满灰尘\n" +
                ...
                "你看到打开了的冬眠仓内静静的摆放着一支螺丝刀，" + obtain(true, new Item_ScrewDriver()) + "\n" +
        ...
        return new NormalCard() {
            ...
            public String description() {
                return "This is a shabby hibernation tank. Its smoothy surface now is full of dust.\n" +
                        ...
                        "There is a screwdriver lay on the inner chamber of the tank, 粗" + obtain(true, new Item_ScrewDriver()) + "\n" +
