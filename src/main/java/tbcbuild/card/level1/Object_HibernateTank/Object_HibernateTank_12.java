...
public class Object_HibernateTank_12 extends ObjectCard implements Printer {
    public Object_HibernateTank_12(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_12() {
        super();
    }
