...
import tbcbuild.card.level1.Finding_HibernateTankInternal_Cool;
...
public class Object_HibernateTank_09 extends ObjectCard implements Printer {

    public Object_HibernateTank_09(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_09() {
        super();
    }
    ...
    public String description() {
        return "这是一个破败的冬眠仓，它本该光洁的外表上现在布满灰尘\n" +
                "冬眠仓的门已经被打开，你正是从这里醒来的\n" +
                "冬眠舱下半部分有一个用螺丝固定的盖子。也许可以用螺丝刀拆开它并" + obtain(true, new Finding_HibernateTankInternal_Cool());
    }
        ...
        return new NormalCard() {
            ...
            public String description() {
                return "This is a shabby hibernation tank. Its smoothy surface now is full of dust.\n" +
                        ...
                        "There is a lid, fixed by screws, on the lower half of the tank. If you have a 粗screwdriver细, you can remove the lid and 粗" + obtain(true, new Finding_HibernateTankInternal_Cool());
            }
        };
    }
}
