...
public class Object_HibernateTank_08 extends ObjectCard implements Printer {

    public Object_HibernateTank_08(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_08() {
        super();
    }
