...
public class Object_HibernateTank_15 extends ObjectCard implements Printer {
    public Object_HibernateTank_15(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Object_HibernateTank_15() {
        super();
    }
