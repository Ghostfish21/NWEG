...
public class Finding_HibernateTankInternal_Cool extends FindingCard implements Printer {
    public Finding_HibernateTankInternal_Cool(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Finding_HibernateTankInternal_Cool() {
        super();
    }
    ...
    public String description() {
        return "冬眠舱内黑乎乎的，你扫了一眼，在里面看到了三块可以拆下来的东西。有两个长得一样，是长方体的黑盒子，剩下的是个电脑机箱那样大的银灰色桶\n" +
                "\n" +
                "你可以花费 3/体质点 点体力将他们拆下来，那么" +
                obtain(true, new Item_BoxBattery_Unpowered(), new Item_BoxBattery_Unpowered(), new Object_CoolDownTank_Filled());
    }
        ...
        return new NormalCard() {
            ...
            public String description() {
                return "The hibernating chamber is dark. You glance at it and see three pieces that can be removed. There were two of the same size, cuboid black boxes, and the rest was a silver-gray bucket the size of a computer case\n" +
                        "\n" +
                        "You can take them down with 3 physical power, then 粗" +
                        obtain(true, new Item_BoxBattery_Unpowered(), new Item_BoxBattery_Unpowered(), new Object_CoolDownTank_Filled());
            }
        };
    }
