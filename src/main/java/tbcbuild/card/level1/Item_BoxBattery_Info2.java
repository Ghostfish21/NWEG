...
public class Item_BoxBattery_Info2 extends ItemCard implements InfoCarrier, Printer {
    public Item_BoxBattery_Info2(boolean bypassValidCheck) {
        super(bypassValidCheck);
    }

    public Item_BoxBattery_Info2() {
        super();
    }
    ...
    public String carriedInfo() {
        String fullInfo = new Finding_BoostedRobot().getReferName();
        return fullInfo.substring(1, 3);
    }
