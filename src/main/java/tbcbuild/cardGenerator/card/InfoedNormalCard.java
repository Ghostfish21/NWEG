...
public abstract class InfoedNormalCard implements CardPrinter, Explorable {

    public abstract String getCarriedInfo();
    ...
    public String paint(String path) {
        ...
        new CardBackWithDescription(null, null).setCarriedInfo(getCarriedInfo()).paint(path+i+".png");
        return null;
    }
}
